        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-md">
              A platform for sharing resources, skills, and tools within your local community. Reduce waste, save money,
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/items/new" className="text-muted-foreground hover:text-foreground">
                  Share an Item
                </Link>
              </li>
              <li>
